...
model_name = framework_model_path.split('.')[-2].split('/')[-1] # gender_model
...
model = torch.load(framework_model_path)
model.to(device)
model.eval()
...
# py pytorch2ONNX_fullmodel.py weights/full_models/gender_full_model.pt 16